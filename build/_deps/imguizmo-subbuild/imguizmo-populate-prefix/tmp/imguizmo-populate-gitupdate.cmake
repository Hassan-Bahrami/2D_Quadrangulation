...
execute_process(
  COMMAND "/usr/bin/git" show-ref "a23567269f6617342bcc112394bdad937b54b2d7"
  WORKING_DIRECTORY "/home/hassan/Projects/ISTA/2D_Quadrangulation/build/_deps/imguizmo-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/hassan/Projects/ISTA/2D_Quadrangulation/build/_deps/imguizmo-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/hassan/Projects/ISTA/2D_Quadrangulation/build/_deps/imguizmo-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
